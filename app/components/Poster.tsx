...
const Poster = () => {
  return (
    <div className='md:w-full poster md:p-8 p-4 flex flex-col md:flex-row md:items-center justify-between rounded-2xl 
      ...
      <div className='flex flex-col md:gap-4 gap-2 md:w-1/2'>
        <p>New Album</p>
        ...
        <div className="md:p-3 p-2 w-fit bg-blue-700 rounded-lg font-bold"> Listen Now</div>
      </div>
      <div className="hidden md:flex relative h-60 w-full md:w-1/2">
        <Image
          src={poster}
          alt="Poster"
          layout="fill"
